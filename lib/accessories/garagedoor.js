...
*/
    ...
    stopSimulatedDimmer(control_motors) {
        this.log.info(`[${this.config.name}] Stopping simulated dimmer (level ${this.level}) (control_motors: ${control_motors})`);
        this.direction = 0;
    ...
    setSimulatedDimmer(target_level, control_motors) {
        this.log.debug(`[${this.config.name}] set Simulated Dimmer: level ${this.level}->${target_level} (control_motors: ${control_motors})`);
	...
	this.direction = direction;
	    ...
	    this.iteration_index++;
            this.log.debug(`[${this.config.name}] ESTIMATOR[${this.iteration_index}]: level ${this.level}`);
